...
#ifndef Rcpp_Module_Extended_h
#define Rcpp_Module_Extended_h

#include <Rcpp/config.h>

namespace RcppModulesExtended{
...
#include <RcppModulesExtended/module/CppFunction.h>
#include <RcppModulesExtended/module/get_return_type.h>
#include <RcppModulesExtended/module/Module_generated_get_signature.h>

    // templates CppFunction0, ..., CppFunction65
#include <RcppModulesExtended/module/Module_generated_CppFunction.h>
#include <RcppModulesExtended/module/class_Base.h>
#include <RcppModulesExtended/module/Module.h>
...
#include <RcppModulesExtended/module/Module_generated_ctor_signature.h>
#include <RcppModulesExtended/module/Module_generated_Constructor.h>
#include <RcppModulesExtended/module/Module_generated_Factory.h>

#include <RcppModulesExtended/module/Module_generated_class_signature.h>
    ...
    public:
        ...
        typedef Rcpp::Reference::Storage Storage ;

        S4_CppConstructor( SignedConstructor<Class>* m, const XP_Class& class_xp, const std::string& class_name, std::string& buffer ) : Rcpp::Reference( "C++ConstructorExtended" ){
        ...
        RCPP_MODULE_EXTENDED_CTOR_ASSIGN_WITH_BASE(S4_CppConstructor)
    ...
    public:
        ...
        S4_CppOverloadedMethods( vec_signed_method* m, const XP_Class& class_xp, const char* name, std::string& buffer ) : Rcpp::Reference( "C++OverloadedMethodsExtended" ){
            int n = m->size();
        ...
        S4_CppOverloadedMethods(named_args_method_class* pm, const XP_Class& class_xp, const char* name, std::string& buffer ) : Rcpp::Reference( "C++OverloadedMethodsExtended" ){
        ...
        RCPP_MODULE_EXTENDED_CTOR_ASSIGN_WITH_BASE(S4_CppOverloadedMethods)

    } ;

#include <RcppModulesExtended/module/Module_CppMethods_named_args.h>
#include <RcppModulesExtended/module/Module_generated_CppMethod.h>
#include <RcppModulesExtended/module/Module_generated_Pointer_CppMethod.h>
    ...
    public:
        typedef Rcpp::XPtr<class_Base> XP_Class ;
        S4_field( CppProperty<Class>* p, const XP_Class& class_xp ) : Rcpp::Reference( "C++FieldExtended" ){
        ...
        RCPP_MODULE_EXTENDED_CTOR_ASSIGN_WITH_BASE(S4_field)

    } ;

#include <RcppModulesExtended/module/Module_Property.h>

#include <RcppModulesExtended/module/class.h>
    ...
    class enum_ {
        public:
            ...
            ~enum_(){
                RcppModulesExtended::Module* module = getCurrentScope() ;
...
// function factories
#include <RcppModulesExtended/module/Module_generated_function.h>
...
namespace RcppModulesExtended {
    ...
    class CppClass : public Rcpp::S4{
        typedef Rcpp::S4 Base;
    public:
        typedef Rcpp::XPtr<class_Base> XP_Class ;
        typedef Rcpp::XPtr<RcppModulesExtended::Module> XP ;
        CppClass( SEXP x) : Rcpp::S4(x){};

        CppClass( Module* p, class_Base* cl, std::string& buffer ) : Rcpp::S4("C++Class") {
	    ...
	    RCPP_MODULE_EXTENDED_CTOR_ASSIGN_WITH_BASE(CppClass)

    } ;

    class CppObject : public Rcpp::S4{
        typedef Rcpp::S4 Base;
    public:
        typedef Rcpp::XPtr<RcppModulesExtended::Module> XP ;
        CppObject( Module* p, class_Base* clazz, SEXP xp ) : Rcpp::S4("C++ObjectExtended") {
            slot( "module" )   = XP( p, false ) ;
            slot( "cppclass" ) = Rcpp::XPtr<class_Base>( clazz, false ) ;
            slot( "pointer" )  = xp ;
        }
        RCPP_MODULE_EXTENDED_CTOR_ASSIGN_WITH_BASE(CppObject)
    } ;

}

RcppModulesExtended::Module* getCurrentScopeExtended();
void setCurrentScopeExtended(RcppModulesExtended::Module* scope) ;

#define RCPP_MODULE_EXTENDED_BOOT(name) _rcpp_module_boot_##name

#define RCPP_MODULE_EXTENDED(name)                                               \
    void _rcpp_module_##name##_init() ;                                 \
    static RcppModulesExtended::Module _rcpp_module_##name( # name ) ;                 \
    extern "C" SEXP _rcpp_module_boot_##name(){                         \
        ::setCurrentScopeExtended( & _rcpp_module_##name ) ;                    \
        _rcpp_module_##name##_init( ) ;                                 \
        Rcpp::XPtr<RcppModulesExtended::Module> mod_xp(& _rcpp_module_##name , false); \
        ::setCurrentScopeExtended( 0 ) ;                                        \
        return mod_xp ;                                                 \
    }                                                                   \
    void _rcpp_module_##name##_init()
...
#define GET_MODULE_EXTENDED_SYM    ( moduleSym == NULL ? moduleSym = Rf_install("Module") : moduleSym )

// this macro is called by code wanting to load a module -- see RInside's rinside_module_sample0.cpp
#define LOAD_RCPP_MODULE_EXTENDED(NAME) \
