...
#ifndef Rcpp_Module_Extended_Module_h
#define Rcpp_Module_Extended_Module_h
...
namespace RcppModulesExtended {
    ...
    class Module {
    public:
        typedef std::map<std::string,Rcpp::CppFunction*> MAP ;
        typedef std::pair<const std::string,Rcpp::CppFunction*> FUNCTION_PAIR ;
        ...
        inline SEXP invoke( const std::string& name_, SEXP* args, int nargs){
            ...
            Rcpp::CppFunction* fun = it->second ;
            if( fun->nargs() > nargs ){
                throw std::range_error( "incorrect number of arguments" ) ;
            }

            return Rcpp::List::create(
                Rcpp::_["result"] = fun->operator()( args ),
                Rcpp::_["void"]   = fun->is_void()
            ) ;
        }
         ...
         * exposed class names
         */
        inline Rcpp::CharacterVector class_names(){
        ...
        /**
         * Returns a Rcpp::List that contains:
         * - an external pointer that encapsulates a Rcpp::CppFunction*
        ...
        inline SEXP get_function( const std::string& name_ ){
            ...
            return Rcpp::List::create(
                Rcpp::XPtr<Rcpp::CppFunction>( fun, false ),
                fun->is_void(),
                fun->docstring,
                sign,
                fun->get_formals(),
        ...
        inline void Add( const char* name_ , Rcpp::CppFunction* ptr){
