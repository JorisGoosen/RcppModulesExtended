...
#ifndef Rcpp_Module_Extended_generated_Factory_h
#define Rcpp_Module_Extended_generated_Factory_h
...
public:
  ...
  virtual Class* get_new( SEXP* args, int nargs ){
      return ptr_fun( Rcpp::bare_as<U0>(args[0]) ) ;
  }
...
public:
  ...
  virtual Class* get_new( SEXP* args, int nargs ){
      return ptr_fun(
          Rcpp::bare_as<U0>(args[0]),
          Rcpp::bare_as<U1>(args[1])
          ) ;
  }
