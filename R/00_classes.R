...
setClassUnion("refGeneratorExtended", c("refObjectGenerator", "refClassGeneratorFunction")) 
...
setRefClass( "C++OverloadedMethodsExtended", 
    fields = list( 
        pointer       = "externalptr", 
        class_pointer = "externalptr", 
        size          = "integer", 
...
setRefClass( "C++ConstructorExtended", 
    fields = list( 
        pointer       = "externalptr", 
        class_pointer = "externalptr", 
        nargs         = "integer", 
...
setClass( "C++Class", 
	representation( 
        ...
        methods_named = "list",
	    constructors  = "list",
	    generator     = "refGeneratorExtended", 
	    docstring     = "character", 
	    typeid        = "character", 
	    enums         = "list", 
	    parents       = "character"
