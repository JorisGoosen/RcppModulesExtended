...
EXTFUN(CppMethod__invoke_pairlist);
EXTFUN(CppMethod__invoke_void_pairlist);
EXTFUN(CppMethod__invoke_notvoid_pairlist);
...
#define RCPP_MODULE_EXTENDED_CTOR_ASSIGN_WITH_BASE(__CLASS__)                                  \
...
__CLASS__( const Rcpp::GenericProxy<Proxy>& proxy ){                           \
