...
//
// You shoulda have received a copy of the GNU General Public License
...
typedef Rcpp::XPtr<RcppModulesExtended::Module> XP_Module;
typedef Rcpp::XPtr<RcppModulesExtended::class_Base> XP_Class;
typedef Rcpp::XPtr<RcppModulesExtended::CppFunctionBase> XP_Function;
...
RCPP_FUN_2(RcppModulesExtended::CppClass, Module__get_class, XP_Module module, std::string cl) {
...
RcppModulesExtended::Module* getCurrentScopeExtended() {
    return RcppModulesExtended::current_scope;
}
void setCurrentScopeExtended(RcppModulesExtended::Module* scope) {
    RcppModulesExtended::current_scope = scope;
}
